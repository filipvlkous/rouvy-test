...
export const useActivityStore = create<ActivityState>((set, get) => ({
  ...
  uploadActivity: async (name: string, type: 'ride' | 'run') => {
    ...
    // Insert with column names matching the Supabase schema
    ...
    //     name: name,
    //     type,
    //     // file_path: filePath, // Changed from file_name/file_url to file_path
    //     distance: parsedData.distance,
    //     duration: Math.round(parsedData.duration), // Ensure integer for duration
    //     elevation_gain: parsedData.elevationGain,
    //     // data_points: parsedData.dataPoints, // Changed from activity_data to data_points
    //   })
    //   .select()
    //   .single();
    ...
    // set((state) => ({
    //   activities: [activityData as Activity, ...state.activities],
    // }));
  },
